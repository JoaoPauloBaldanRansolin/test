...
date_default_timezone_set('America/Recife');
	...
	if ($_GET['sq']  == 'salvar') {
		...
		$sql = "insert into tpessoa(id, nome, datanascimento,nomepai,nomemae,celular,pais) 
		values($_GET[id], '$_GET[nome]','$_GET[datanascimento]','$_GET[nomepai]','$_GET[nomemae]','$_GET[celular]' ,'$_GET[pais]'   )";
		...
		$sql = "
			select id, nome, nome,datanascimento,nomepai,nomemae,celular,pais
			from tpessoa 
			where id = '$_GET[id]'";
