                            ...
                            <body onload="document.getElementById('cpfcnpj').focus();">
                                <table border="0" align=center width="100%" class='redonda'>
                                        ...
                                        <td>
                                            <div class='input-group'>
                                                <span class='input-group-btn'>
                                                    ...
                                                    <input class='redonda' value='' type='text' id='placa' size='19' maxlength="15" size="12" onkeypress="mascara(this,soNumeros)" onchange="buscaajax(this.value)" tabindex=1>
                                    ...
                                    <tr>
                                        ...
                                        <td for="foto">foto</td>
                                        <td><input type="file" id="foto" size='25' name="foto"></td>
                                    </tr>

                                    <tr>
                                        <td>Marca</td>
                                        <td><input class='redonda' type='text' id='marca' name='marca' size='25' maxlength='10' tabindex=11></td>

                                        <td>Doc. Veiculo</td>
                                        <td><input class='redonda' type='file' name='docveiculo' id='docveiculo' size='25' maxlength='10' onkeypress="mascara(this,mascaradata)" tabindex=11></td>
                                    </tr>

                                    <tr>
                                        <td>Modelo</td>
                                        <td><input class='redonda' type='text' name="modelo" id='modelo' size='25' maxlength='10' onkeypress="mascara(this,mascaradata)" tabindex=11></td>

                                        <td for="cor">Cor</td>
                                        <td><input type="text" id="cor" size='25' name="cor" required></td>
                                    </tr>

                                    <tr>
                                        <td>Doc. proprietário</td>
                                        <td><input class='redonda' type='text' id='docprop' name='docprop' size='25' maxlength='10' onkeypress="mascara(this,mascaradata)" tabindex=11></td>

                                    </tr>

                                    <tr>
                                        <td for="nomeProp">Nome prop.</td>
                                        <td><input type="text" id="nomeprop" size='25' name="nomeprop" required></td>

                                        <td for="anoFabric">Ano fabr.</td>
                                        <td><input type="date" id="anofabric" size='25' maxlength='15' name="anofabric" required></td>
...
<script>
    function buscaajax() {
        ...
        vajaxmot.open('get', "placa_sql2.php?&sq=buscar" +
...
<script>
    function salvar() {
        ...
        formDataf.append('foto', fotos);

        var docveiculo = document.getElementById('docveiculo');
        var docs = docveiculo.files[0];
        var formDatad = new FormData();
        formDatad.append('docveiculo', docs);

        vajaxmot.open('get', "placa_sql2.php?&sq=salvar" +
            "&placa=" + document.getElementById('placa').value +
            "&categoria=" + document.getElementById('categoria').value +
            "&marca=" + document.getElementById('marca').value +
            "&modelo=" + document.getElementById('modelo').value +
            "&docprop=" + document.getElementById('docprop').value +
            "&cor=" + document.getElementById('cor').value +
            "&nomeprop=" + document.getElementById('nomeprop').value +
            "&docveiculo=" + formDatad +
            "&anofabric=" + document.getElementById('anofabric').value +
            "&foto=" + formDataf +
